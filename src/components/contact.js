...
const  ContactUs=()=> {
    ...
    return(
        <div className="container">
            ...
            <h2 style={{borderBottom:"4px solid yellow",color:"black",width:"130px",margin:"auto auto",textAlign:"center",marginBottom:"20px"}}>Contact</h2>
                <GoogleApiWrapper/>
            ...
            <form style={{margin:"20px"}} onSubmit={sendEmail}>
                    <div className="row pt-5 mx-auto">
                        <div className="col-8 form-group mx-auto">
                            <input style={{marginTop:"40% "}} type="text" className="form-control" placeholder="Name" name="name"/>
                        </div>
            ...
            <div className="col-md-4">
                <div className="row">
                    <div className="">
                       <GoLocation style={{fontSize:"40px" ,padding:"5%"}}/>
                    </div>
                    <div>
                        <h4>Address</h4>
                        <p>Younus khan Scholars Garden
...
<div className="col-md-4">
                <div className="row">
                    <div className="">
                       <FiPhoneCall style={{fontSize:"40px" ,padding:"5%"}}/>
                    </div>
                    <div>
                        <h4>Call Me</h4>
                        <p>01708735449
                ...
                <div className="row">
                    <div className="">
                       <BiMailSend style={{fontSize:"40px",padding:"5%"}}/>
                    </div>
                    <div>
                        <h4>Enquires</h4>
                        <p>ahsanfe.contact@gmail.com
